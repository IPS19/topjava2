...
import static com.github.IPS19.restaurant_voting_app.web.user.AdminUserController.REST_URL;
import static com.github.IPS19.restaurant_voting_app.web.user.UserTestData.*;
...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_MATCHER.contentJson(admin, guest, user, user4, user5, user6));
    }
