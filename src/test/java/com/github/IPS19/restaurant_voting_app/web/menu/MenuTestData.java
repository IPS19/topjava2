...
public class MenuTestData {
    ...
    public static final Menu menu1 = new Menu(MENU1_ID, List.of(new DishItem(100, "burgers"), new DishItem(120, "middle burgers"),
            new DishItem(150, "big burgers")), LocalDate.now());
    public static final Menu menu2 = new Menu(MENU1_ID + 1, List.of(new DishItem(101, "sushi"), new DishItem(121, "middle sushi"),
            new DishItem(151, "big sushi")), LocalDate.now());
    public static final Menu menu3 = new Menu(MENU1_ID + 2, List.of(new DishItem(102, "pizza"), new DishItem(122, "middle pizza"),
            new DishItem(152, "big pizza")), LocalDate.now());
    public static final Menu oldMenu1 = new Menu(MENU1_ID + 3, List.of(new DishItem(152, "restaurant_1 old menu item"),
            new DishItem(152, "restaurant_1 old menu item2"), new DishItem(152, "restaurant_1 old menu item3")),
            LocalDate.of(2021, 5, 5));
    public static final Menu oldMenu2 = new Menu(MENU1_ID + 4, List.of(new DishItem(152, "restaurant_2 old menu item"),
            new DishItem(152, "restaurant_2 old menu item2"), new DishItem(152, "restaurant_2 old menu item3")), LocalDate.of(2021, 5, 5));
    public static final Menu oldMenu3 = new Menu(MENU1_ID + 5, List.of(new DishItem(152, "restaurant_3 old menu item"),
            new DishItem(152, "restaurant_3 old menu item2"), new DishItem(152, "restaurant_3 old menu item3")),
            LocalDate.of(2021, 5, 5));

    public static final Menu notValidMenu = new Menu(MENU1_ID + 2, List.of(new DishItem(0, "ONE ITEM")),
            LocalDate.now());
