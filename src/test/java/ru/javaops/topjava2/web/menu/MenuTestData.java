...
public class MenuTestData {
    ...
    public static final Menu oldMenu1 = new Menu(MENU1_ID + 3, Map.of("restaurant_1 old menu item", 152,
            "restaurant_1 old menu item2", 152, "restaurant_1 old menu item3", 152), LocalDate.of(2021,5,5));
    public static final Menu oldMenu2 = new Menu(MENU1_ID + 4, Map.of("restaurant_2 old menu item", 152,
            "restaurant_2 old menu item2", 152, "restaurant_2 old menu item3", 152), LocalDate.of(2021,5,5));
    public static final Menu oldMenu3 = new Menu(MENU1_ID + 5, Map.of("restaurant_3 old menu item", 152,
            "restaurant_3 old menu item2", 152, "restaurant_3 old menu item3", 152), LocalDate.of(2021,5,5));
    ...
    public static MenuTo getNew() {
        return new MenuTo(Map.of("new item1", 100, "new item2", 200, "new item3", 300), LocalDate.now());
    }

    public static MenuTo getNotValid() {
        return new MenuTo(Map.of("ONE ITEM", 100), LocalDate.now());
    }
}
